                    ...
                    if (snapshot.data == null) {
                      ...
                      if (!snapshot.hasData || snapshot.data!.length == 0) {
                        ...
                        if (showCurrentUserReviews) {
                          ...
                          reviewsToShow = reviewsToShow.where((review) => request.getJsonData().containsValue(review.fields.username)).toList();
                        }
                                  ...
                                  Container(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Spacer(),
                                        if (request.getJsonData().containsValue(reviewsToShow[index].fields.username))
                                          InkWell(
                                            onTap: () async {
                                              // Implementasi logika hapus review di sini
                                              // Misalnya, panggil fungsi hapusReview(reviewsToShow[index].id)
                                              await hapusReview(reviewsToShow[index].pk);
                                            },
                                            child: Container(
